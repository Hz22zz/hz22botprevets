...
conn.reply(m.chat, `
https://cararegistrasi.com/anvGEY

Contoh:
1. Harap klik link tersebut
2. cari tombol click here to continue
3. Klik tombol *Im not a robot*
4. Lanjut klik *Click continue here*
5. terus klik tombol kembali jika terbuka tab baru
6. klik tombol *get link*
7. terus klik tombol kembali jika terbuka tab baru
8. Tutup *google crome*
9. Tunggu hasilnya akan di proses  🎉
