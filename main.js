...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6281228391267@s.whatsapp.net`, {text: 'BERHASIL TERSAMBUNG KE BOT ✿Hz22✿ JANGAN LUPA SAVE Hz22, PASTI DI SAVEBACK' })
}
